...
from model import RotPro, PairRE, RotProPair
...
def main():
    ...
    """set up model"""
    if args.model_name == 'RotPro':
        model_class = RotPro
    elif args.model_name == 'PairRE':
        model_class = PairRE
    elif args.model_name == 'RotProPair':
        model_class = RotProPair
    else:
        model_class = import_class(f"neuralkg.model.{args.model_name}")
    print(args.max_epochs)
    if args.max_epochs == None:
        args.max_epochs = 4000
    ...
    model_checkpoint = pl.callbacks.ModelCheckpoint(
        monitor="Eval,mrr",                             # 这边改掉了！！！！！！！！！！！！1
        mode="max",
        filename="{epoch}-{Eval,mrr:.3f}",              # 这边改掉了！！！！！！！！！！！！1
        dirpath=dirpath,
